...
class TestOptions:
    ...
    def initialize(self):
        self.parser.add_argument('--dataset', type=str, default='CelebA-HQ_512',
                                 help='The dataset of the experiment.')
        self.parser.add_argument('--data_file', type=str, default='./imgs/celebahq_512x512', help='the file storing testing file paths')
        self.parser.add_argument('--test_dir', type=str, default='./test_results', help='models are saved here')
        self.parser.add_argument('--load_model_dir', type=str, default='./checkpoints/celebahq_512x512_freeform', help='pretrained models are given here')
    ...
    def parse(self):
        ...
        print('-------------- End ----------------')
        print("This is example: ",self.opt)
        return self.opt
