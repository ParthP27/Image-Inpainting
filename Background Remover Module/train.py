...
if __name__=='__main__':
        ...
        parser.add_argument('--train_data_path',type=str ,default="D://project52//data1" ,help='training data path')
        ...
        parser.add_argument('--height',type=int ,default=1024 ,help='images height')
        ...
        sess = tf.Session()
        if args.stage == 0:
            g_vars, _, adv_g_loss, _,rec_loss, correlation_loss, style_loss = build_graph_with_loss(images, batch_size, mask, args.vgg_path, args.adv_type , args.stage,args.lambda_style, args.lambda_cor, args.alpha, args.lambda_adv)
